...
import { isHuntersHoundsClient } from '@/lib/clientDomainDetection'; // CLIENT-SIDE version
...
// ENHANCED Hunter's Hounds Booking Experience with Authentication Detection
function HuntersHoundsBooking() {
  // --- State for Authentication Detection ---
  ...
  const checkForAuthenticatedUser = async () => {
    try {
      // Check URL parameters for user context from dashboard
      ...
      if (userPhone || userEmail) {
        ...
        if (queryParam) {
          console.log("📞 Fetching authenticated user with:", queryParam);
          const response = await fetch(`/api/dog-walking/customer-lookup?${queryParam}`);
          const data = await response.json();

          console.log("📋 Authentication response:", { status: response.status, found: data.found });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* Header Section - Enhanced with Authentication */}
          ...
          {authenticatedUser ? (
            <>
              <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent">
                Welcome Back, {authenticatedUser.owner_name}!
              </h1>
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Ready for another walk? Choose your service and pick the perfect time for your furry friend
              </p>
            </>
          ) : (
            <>
        ...
        {/* Booking Section - Enhanced with Authentication */}
        <section className="mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
            ...
            {/* Booking Calendar - Center - Enhanced with currentUser */}
            <div className="max-w-2xl mx-auto w-full">
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">
                ...
                <MobileBookingCalendar 
                  currentUser={authenticatedUser}  // NEW: Pass authenticated user
                />
              </div>
            </div>
        ...
        {/* Quick Service Info - Preserved exactly as original */}
        <section className="mb-16">
        ...
        {/* Need Help Section - Preserved exactly as original */}
...
// ORIGINAL DutchBrat Experience (preserved exactly as original)
        ...
        <section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="max-w-xl mx-auto w-full bg-gray-900 rounded-lg p-2 lg:col-span-1">
              <MobileBookingCalendar currentUser={null} />
            </div>
